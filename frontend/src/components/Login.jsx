            ...
            <div className="text-center bg-zinc-800 p-8 rounded-lg shadow-lg w-96 flex flex-col items-center">
                ...
                <form onSubmit={handleSubmit} className="w-full">
                    <div className="mb-4">
                        ...
                        <input type="text" placeholder="Use your email here." value={email} onChange={handleEmailChange} className="w-full px-4 py-2 rounded border border-zinc-500 bg-zinc-600 text-white focus:outline-none"/>
                    </div>
                    <div className="mb-2 relative">
                        <label htmlFor="password" className="text-left text-white text-xl mb-1 block">Password</label>
                        <input type={showPassword ? "text" : "password"} placeholder="Use your password here." value={password} onChange={handlePasswordChange} className="w-full px-4 py-2 rounded border border-zinc-500 bg-zinc-600 text-white focus:outline-none"/>
                    ...
                    <button type="submit" className={`bg-blue-600 text-white mt-5 px-4 py-2 w-36 rounded hover:bg-blue-500 ${isFormValid ? '' : 'cursor-not-allowed'}`} disabled={!isFormValid}>Login</button>
                </form>
            </div>
        </div>
    );
